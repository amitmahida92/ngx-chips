...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_first__ = __webpack_require__(57);
...
var TagInputDropdown = (function () {
    ...
    TagInputDropdown.prototype.onItemChecked = function (event) {
...
var TagInputComponent = (function (_super) {
    ...
    TagInputComponent.prototype.isTagValid = function (tag, fromAutocomplete) {
        ...
        if (!this.allowDupes && dupe && this.blinkIfDupe) {
            var model = this.tags.find(function (intag) {
                return _this.getItemValue(intag.model) === _this.getItemValue(dupe);
            });
            if (model) {
                model.blink();
            }
    ...
    TagInputComponent.prototype.addItem = function (fromAutocomplete, item, index) {
        ...
        var reset = function () {
            _this.setInputValue(_this.inputTextValue);
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], TagInputComponent.prototype, "displayInlineTags", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Array)
